...
export default function PairTV(){
 ...
 return <main className="page"><section className="hero"><h1>Kết nối Long TV</h1><p>QR động • Trusted Device • một chạm cho lần sau</p></section><section className="panel" style={{marginTop:12}}><div className="notice">{msg}</div><button data-action-id="mobi.app.tv.pair.token.page.button.001" className="action" onClick={pair}>Kết nối TV</button></section></main>
}